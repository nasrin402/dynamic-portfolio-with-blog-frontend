			...
			<div className="row">
				<div className="col-md-12 col-lg-12">
					<div className="section_title_1 text-center mx-auto pb_60 wow animated slideInUp">
	                    <h2 className="title text-uppercase color_white"><span className="line_double mx-auto color_default">Blog</span>Create your article</h2>
	                    <span className="sub_title color_lightgray">Fill up all the fields to post your blog.</span>
	                </div>
				</div>
				<div className="col-md-12 col-lg-12">
					<div className="row">
