			...
			<div className="row">
				...
				<div className="col-md-12 col-lg-12">
    				<div className="testimonial_item owl-carousel wow animated slideInUp">
    					<div className="member_feedback color_lightgray p_30">
							<div className="client_img"><img src="images/testimonial/01.jpg" alt="image"/></div>
							...
							<h5 className="color_gray mb_15">Aisha Lexi</h5>
						...
						<div className="member_feedback color_lightgray p_30">
							<div className="client_img"><img src="images/testimonial/02.jpg" alt="image"/></div>
							<div className="star d-inline-block mt_30 color_default">
								<ul>
									<li><i className="fa fa-star" aria-hidden="true"></i></li>
									<li><i className="fa fa-star" aria-hidden="true"></i></li>
							...
							<h5 className="color_gray mb_15">Kiara Paige</h5>
							<p>Sem duis platea erat feugiat vivamus nascetur sapien tortor. Sollic dictum ultric. Aliquam inceptos bibendum fringilla sodales. Molest lacin urna per aenean commodo sociosqu.</p>
						</div>
						<div className="member_feedback color_lightgray p_30">
							<div className="client_img"><img src="images/testimonial/03.jpg" alt="image"/></div>
							<div className="star d-inline-block mt_30 color_default">
								<ul>
									<li><i className="fa fa-star" aria-hidden="true"></i></li>
									<li><i className="fa fa-star" aria-hidden="true"></i></li>
							...
							<h5 className="color_gray mb_15">Lucas Noah</h5>
							<p>Sem duis platea erat feugiat vivamus nascetur sapien tortor. Sollic dictum ultric. Aliquam inceptos bibendum fringilla sodales. Molest lacin urna per aenean commodo sociosqu.</p>
						</div>
						<div className="member_feedback color_lightgray p_30">
							<div className="client_img"><img src="images/testimonial/04.jpg" alt="image" /></div>
							<div className="star d-inline-block mt_30 color_default">
								<ul>
									<li><i className="fa fa-star" aria-hidden="true"></i></li>
									<li><i className="fa fa-star" aria-hidden="true"></i></li>
							...
							<h5 className="color_gray mb_15">Grace Ruby</h5>
							<p>Sem duis platea erat feugiat vivamus nascetur sapien tortor. Sollic dictum ultric. Aliquam inceptos bibendum fringilla sodales. Molest lacin urna per aenean commodo sociosqu.</p>
						</div>
    				</div>
    			</div>
