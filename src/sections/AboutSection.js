...
import about from '../img/about/03.png';
...
const AboutSection = () => {
    ...
    return (
        <section id="about" name="about" className="py_80 bg_black full_row">
		<div className="container">
			<div className="row">
				<div className="col-md-12 col-lg-12">
					<div className="section_title_1 text-center mx-auto pb_60 wow animated slideInUp">
	                    <h2 className="title text-uppercase color_white"><span className="line_double mx-auto color_default">about</span>about myself</h2>
			...
			<div className="about_one">
				<div className="row">
					<div className="col-md-7 col-lg-7">
						<div className="myself color_lightgray wow animated fadeInLeft">
						...
						<div className="personal_info color_lightgray">
							<div className="row">
								<div className="col-md-12 col-lg-6">
									<ul>
										<li><span className="color_secondery">Name :</span> Austin Jackson</li>
										<li><span className="color_secondery">Email :</span> yourdomainname@gmail.com</li>
										<li><span className="color_secondery">Phone :</span> +00 61 700 800</li>	
									</ul>
								</div>
								<div className="col-md-12 col-lg-6">
									<ul>
										<li><span className="color_secondery">Date of Birth :</span> 14 December 1993</li>
										<li><span className="color_secondery">Blood Group :</span> A+</li>
										<li><span className="color_secondery">Address :</span> Mouroubra WA 6472, Australia.</li>
									</ul>
								</div>
							</div>
						</div>
					...
					<div className="col-md-5 col-lg-5">
						<div className="profile_img personal_video wow animated fadeInRight">
							...
							<div className="iconround"><a className="video-popup venobox" href="https://youtu.be/cezsFi_522M" data-vbtype="video" title="video popup">
							<i className="fa fa-play" aria-hidden="true"></i></a></div>
